  ...
  g
    ...
    , g
      ...
      , polyline
        ...
        , stroke "#000000"
        , strokeMiterlimit "10"
        , points "44.821,190.096 45.696,187.226 48.57,186.367"
        ]
        []
...
sectionPoints sectionId =
  case sectionId of
    ...
    BoneBreaker -> "683.726,549.285 683.726,554.285 738.94,554.813 760.721,532.02 755.721,532.02 737.94,549.813"
